    ...
    <div class="main" v-else>
      <div class="card">
        ...
        <div class="yaoqin" @click="showMask = true">
          ...
          <div class="right">
            <span class="text"> 点击右上角分享按钮，邀请好友互拜对方的本尊罗汉，为彼此增添好运！</span>
          </div>
        </div>
        <div class="btn yl_btn" @click="comeback">
          <span class="btn_text" v-if="infoData.userInfo.yidamArhatId"> 去拜罗汉 </span>
                   <span class="btn_text" v-else> 去数罗汉 </span>
        </div>
